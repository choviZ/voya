...
/** 此处后端没有提供注释 GET /chat/history/list */
export async function listAppChatHistory(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.listAppChatHistoryParams,
  options?: { [key: string]: any }
) {
  return request<API.BaseResponsePageChatHistory>('/chat/history/list', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function listAllChatHistoryByPageForAdmin(
  ...
  return request<API.BaseResponsePageChatHistory>('/chat/history/admin/list/page', {
    method: 'POST',
    headers: {
